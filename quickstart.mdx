---
title: "Vision"
description: "At Coffee, our goal is to provide advanced agent infrastructure to allow anyone to create fully custom agents for a wide variety of use cases."
---

## Mission

<Card title="Agent Infrastructure">
  Foster open-source, agent infrastructure, enabling anyone to build and deploy on-chain agents.
</Card>
